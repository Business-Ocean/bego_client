...
const pt8 = EdgeInsets.only(top: 8);
const pt12 = EdgeInsets.only(top: 12);
...
const pb8 = EdgeInsets.only(bottom: 8);
const pb12 = EdgeInsets.only(bottom: 12);
...
const pl8 = EdgeInsets.only(left: 8);
const pl12 = EdgeInsets.only(left: 12);
...
const pr8 = EdgeInsets.only(right: 8);
const pr12 = EdgeInsets.only(right: 12);
