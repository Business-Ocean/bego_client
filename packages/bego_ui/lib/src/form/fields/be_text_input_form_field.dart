...
class BeTextInputFormField extends FormField<String> {
  BeTextInputFormField({
    super.key,
    String? initialValue,
    this.controller,
    super.onSaved,
    ...
    bool enableSuggestions = true,
        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            final state = field as _InputFormFieldState;

            return BeTextInputField(
...
class _InputFormFieldState extends FormFieldState<String> {
  ...
  @override
  BeTextInputFormField get widget => super.widget as BeTextInputFormField;
  ...
  @override
  void didUpdateWidget(BeTextInputFormField oldWidget) {
